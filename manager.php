...
if (isset($_POST['btnsubmit']))
 {
    ...
    (1,1,'$first_name','$last_name','MANAGER','$email','$password','','0','0',Unix_timestamp()*1000,Unix_timestamp()*1000)";
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
              ...
              <div class="card-header"><h5>Add Manager</h5></div>
             ...
             <div>
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                        <?php
                        $data =array();
                        $sql="Select * FROM user WHERE type='MANAGER' AND is_deleted=0";
