...
if(isset($_GET['id']))
{
    $_SESSION['suiteIdForBooking'] = $_GET['id'];
    $id = $_GET['id'];
    $qryToGetDetail = "SELECT * FROM suite WHERE id='$id'";
    $res = mysqli_query($con,$qryToGetDetail);
    if($res)
    {
        if(mysqli_num_rows($res)>0)
        {
            $row = mysqli_fetch_array($res);
            $_SESSION['suiteIdForBooking']   = $row['id'];
            $_SESSION['suiteTitleForBooking'] = $row['title'];
            $_SESSION['suiteImageForBooking'] = $row['title_image'];
            $_SESSION['suitePriceForBooking'] = $row['price'];
...
if(isset($_POST['btnBook']))
{
    ...
    $suiteId       =  $_SESSION['suiteIdForBooking'];
    $suiteName     = $_SESSION['suiteTitleForBooking'];
    $suitePrice    =  $_SESSION['suitePriceForBooking'];
    $suiteImage    = $_SESSION['suiteImageForBooking'];
                            ...
                            <div class="boking_table">
                                ...
                                <div class="col-md-4">
                                        <div class="book_tabel_item">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" value="<?php echo  $_SESSION['suiteTitleForBooking']; ?>" />
                                            </div>
                                        </div>
                                    </div>
